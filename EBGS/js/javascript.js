...
var Resistor = function (x, y) {
    ...
    this.A = new point(canvas.id, null, this.x - 40, this.y + this.height / 2, 6, pointType.PASSIVE, "");
    this.B = new point(canvas.id, null, this.x + 100, this.y + this.height / 2, 6, pointType.PASSIVE, "");
    ...
    this.draw = function () {
        ...
        canvas.context.beginPath();
        canvas.context.moveTo(this.x + 60, this.y + this.height / 2);
        canvas.context.lineTo(this.x + 96, this.y + this.height / 2);
        canvas.context.lineWidth = 4;
        canvas.context.stroke();
        canvas.context.closePath();
        ...
        canvas.context.beginPath();
        canvas.context.moveTo(this.x, this.y + this.height / 2);
        canvas.context.lineTo(this.x + 60, this.y -  this.height / 32);
        ...
        canvas.context.beginPath();
        canvas.context.moveTo(this.x, this.y + this.height / 2);
        canvas.context.lineTo(this.x + 60, this.y +  this.height );
        canvas.context.lineWidth = "7";
        canvas.context.stroke();
        canvas.context.closePath();

        canvas.context.beginPath();
        canvas.context.moveTo(this.x + 60, this.y -  (this.height / 32)-3 );
        canvas.context.lineTo(this.x + 60, this.y +  this.height +3 );
        canvas.context.lineWidth = "7";
        canvas.context.stroke();
        canvas.context.closePath();
...
var Galvanometer = function (x, y) {
    ...
    this.maxValue = 60;
    this.minValue = -60;
    this.A = new point(canvas.id, null, this.x -36, this.y + this.height / 2, 6, pointType.PASSIVE, "");
    this.B = new point(canvas.id, null, this.x +28+ this.width - 3, this.y + this.height / 2, 6, pointType.PASSIVE, "");
    this.A.V = "+ve";
    this.B.V = "-ve";
    this.draw = function () {
...
var Potentiometer = function (x, y) {
    ...
    this.O = new point(canvas.id, null, this.x + 40, this.y-20 , 6, pointType.ACTIVE_PASSIVE, "");
    this.B = new point(canvas.id, null, this.x + 40, this.y + 50, 6, pointType.PASSIVE, "");
    this.A.V="";
    this.O.V="+ve";
    this.B.V="-ve";
    ...
    this.draw = function () {
        ...
        canvas.context.beginPath();
            canvas.context.moveTo(this.x + 40, this.y );
            canvas.context.lineTo(this.x + 40, this.y-17);
            canvas.context.lineWidth = 3;
            canvas.context.stroke();
            canvas.context.closePath();

        canvas.context.beginPath();
        canvas.context.moveTo(this.x + 40, this.y+30 );
        canvas.context.lineTo(this.x + 40, this.y + 47);
        canvas.context.lineWidth = 3;
        canvas.context.stroke();
        canvas.context.closePath();
