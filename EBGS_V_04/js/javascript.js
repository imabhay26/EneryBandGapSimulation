...
var TapKey = function (x, y) {
    ...
    this.draw = function () {
        ...
        canvas.context.drawImage(img2, 576-60, 85,100,100);
        ...
        canvas.context.moveTo(610-60 , 400);
        canvas.context.lineTo(615-60 , 400);
        canvas.context.moveTo(610-60 , 405);
        canvas.context.lineTo(615-60 , 405);
        canvas.context.moveTo(610-60 , 410);
        canvas.context.lineTo(615-60 , 410);
        canvas.context.moveTo(610-60 , 415);
        canvas.context.lineTo(615-60 , 415);
        canvas.context.moveTo(610-60 , 420);
        canvas.context.lineTo(620-60 , 420);



        canvas.context.strokeStyle = "#824932";
...
var Galvanometer = function (x, y) {
    ...
    this.maxValue = 60;
    this.minValue = -60;
    this.A = new point(canvas.id, null, this.x -36, this.y + this.height / 2, 6, pointType.PASSIVE, "+ve");
    this.B = new point(canvas.id, null, this.x +28+ this.width - 3, this.y + this.height / 2, 6, pointType.PASSIVE, "-ve");
    this.A.V = "";
    this.B.V = "";
    this.draw = function () {
